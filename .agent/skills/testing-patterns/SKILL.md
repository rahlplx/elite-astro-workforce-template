...
| Type            | Best For               | Speed        | Tool |
| :---            | :---                   | :---         | :--- |
| **Unit**        | Utilities, pure logic  | Fast         | Vitest |
| **Component**   | Astro components       | Fast         | Vitest / Container |
| **Integration** | Astro Actions          | Medium       | Vitest |
| **E2E**         | User flows, hydration  | Slow         | Playwright |

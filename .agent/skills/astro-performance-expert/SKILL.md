...
description: Web performance optimization for Astro sites. Adapted from Vercel Engineering's 57 rules. Use when optimizing page load speed, eliminating waterfalls, reducing bundle size, or improving Core Web Vitals.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# Astro Performance Expert

> **Adapted from Vercel Engineering** - 57 optimization rules prioritized by impact
> **Philosophy:** Eliminate waterfalls first, optimize bundles second, then micro-optimize.
> **Astro Focus:** Server-first, zero JS by default, Islands Architecture for interactivity.

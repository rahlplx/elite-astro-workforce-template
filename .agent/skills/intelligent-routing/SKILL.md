...
**Purpose**: Automatically analyze user requests and route them to the most appropriate specialist agent(s) using the **Elite Graph Engine**.

## Core Principle

> **The AI should act as an Elite Conscience**, analyzing each request against the **ELITE_PROTOCOL.md** and automatically selecting the best specialist(s) from the graph. Every complex journey begins with **elite-core** coordination.
...
| **Research/Knowledge** | "notebooklm", "research", "sources"       | `notebooklm-expert`                         | ✅ YES       |
| **AI Design**          | "stitch", "generate UI", "labs design"     | `stitch-designer`                           | ✅ YES       |
...
| **Research**    | notebooklm, research, notebook, podcast    | `notebooklm-expert`     |
| **Design**      | stitch, prototyping, ui-gen                | `stitch-designer`       |
